...
class BusinessMan extends Man {
	...
	/*
	상속받은 자식클래스는 부모클래스의 생성자를 호출하여 부모 인스턴스가 메모리에 먼저 생성되도록 해야한다.
	...
	public void tellYourInfo() {
		...
		/*
		부모클래스의 멤버변수 name은 private으로 선언되었으므로 상속받은 자식클래스에서는 접근할 수 없다.
		private 멤버는 무조건 클래스 내부에서만 접근할 수 있다.
		 */
		// System.out.println("이름은 " + name + " 입니다.");
		/*
		부모클래스에 public으로 선언된 메서드를 통해 간접적으로 접근하여 사용할 수 있다.
		 */
		tellYourName();
	}
}

...
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		시나리오] for문을 이용하여 1 ~ 100까지의 합을 구하는 프로그램을 작성하시오.
		 */
		// 누적합 저장용 변수 선언
		int sum = 0;
		...
		System.out.println("1 ~ 10 사이 2의 배수의 합 (방법 2) : " + total);
		...
		/*
		for 문의 끝에 ;을 사용하면 반복할 문장이 없는 것으로 간주되어 for문과 상관없이 한번만 실행된다. 즉 잘못된 문장이다.
		 */
		for (int j = 0; j <= 5; j++) {
		...
		/*
		for문의 초기값을 외부 (넓은지역, 여기서는 main메서드 지역)에서 선언하면 해당 변수는 for문의 안쪽(좁은지역)에서 사용할 수 없다.

...
- Java에선느 배열을 인스턴스 형태로 생성하므로 new 를 사용한다.
...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		인스턴스 배열 : 기본 자료형을 저장하는 배열이 아닌 인스턴스의 참조값을 저장할 목적으로 생성한 배열을 말한다.
			사용법은 일반 배열과 동일하다.
		 */
		...
		/*
		배열을 선언과 동시에 초기화하는 경우 자바 컴파일러는 초기값의 개수를 통해 배열의 크기를 결정할 수 있다.
		...
		int arrSum = 0;
		for (int x = 0; x < initArr2.length; x++) {
			arrSum += initArr3[x];
		}

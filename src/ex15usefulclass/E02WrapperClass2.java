...
public class E02WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		isWhiteSpace() : 공백문자인지 판단하는 메서드로 공백문자일 때 true를 반환한다.
		isLowerCase() / isUpperCase() : 소문자 혹은 대문자인지 판단한다. 만약 영문이 아닌 경우에는 무조건 false를 반환한다.
		 */
		...
		System.out.println(Character.isDigit('A') ? "숫자입니다" : "숫자가 아닙니다");
		System.out.println(Character.isDigit(50) ? "숫자입니다" : "숫자가 아닙니다");
		System.out.println(Character.isDigit('7') ? "숫자입니다" : "숫자가 아닙니다");

		// isLetter()
		System.err.println("isLetter()를 통한 문자판단");
		...
		*/
		System.err.println("시나리오");
		String whiteString = "h   e  l       l    o";
		char[] whiteArray = whiteString.toCharArray();
		int cnt = 0;
		for (int i = 0; i < whiteArray.length; i++) {
			if (Character.isWhitespace(whiteArray[i])) {
				cnt++;
			}
		}

...
/*
Wrapper class : 기본자료형의 데이터를 인스턴스화할 때 사용하는 클래스로 Boxing 혹은 Unboxing을 통해 기본자료형의 데이터를 인스턴스화 한다.
...
public class E01WrapperClass1 {
	public static void main(String[] args) {
		...
		/*
		JDK1.4 이전의 코딩형식
		기본자료형을 박싱 처리한 인스턴스에 대해 산술연산을 진행할 때 언박싱에 위해 intValue()와 같은 메서드를 호출해야 한다.
		 */
		// 현재는 이 같은 생성자는 Deprecated(디플리케이트) 되었다.
		...
		오토박싱 혹은 오토언박싱이 지원되므로 기본자료형 변수를 사용하는 것과 동일하게 코딩할 수 있다.
		 */

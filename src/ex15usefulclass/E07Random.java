...
public class E07Random {
	...
	public static void main(String[] args) {
		...
		만약 동일한 Seed를 사용하면 항상 동일한 패턴의 난수가 생성되는데 이를 가짜난수 (Pseudo-random number)라고 한다.
		 */
		...
		이때 현재시간을 밀리세컨즈 단위로 반화하는 메서드를 사용하면 편리하다.
		...
		이 경우에는 Math.abs()를 통해 양수로 변화하고 특정수를 나누는 형태로 필요한 난수를 생성할 수 있다.
		 */
		System.out.println("\n# 난수생성 3 : nextInt() 인수없음");

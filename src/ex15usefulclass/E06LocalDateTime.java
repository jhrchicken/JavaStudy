...
public class E06LocalDateTime {
	...
	public static void main(String[] args) {
		...
		/*
		Period클래스 : 두 날짜 사이의 간격을 나타낸다. ?개월 ?일 남음으로 표시할 수 있다.
		 */
		Period period = Period.between(localDate, xMas);
		System.out.println(period.getMonths() + "개월 " + period.getDays() + "일 남았습니다.");

		/*
		ChronoUnit클래스 : 특정 시간 단위로 날짜의 차이를 계산한다.
		 */
		// ?개월 남음 : 남은 개월수를 표시
		System.out.println(ChronoUnit.MONTHS.between(localDate, xMas) + "개월 남았습니다.");
		// 남은 전체일수를 표시
		System.out.println(ChronoUnit.DAYS.between(localDate, xMas) + "일 남았습니다.");

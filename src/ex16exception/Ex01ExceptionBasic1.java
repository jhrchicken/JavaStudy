...
public class Ex01ExceptionBasic1 {
	...
	public static void main(String[] args) throws IOException {
		...
		if (true);
		{}
		else -> if문이 세미콜론으로 종료되어 의미없는 else문이 되었다.
		{}
		*/
		...
		/*
		외부자원을 사용할 때 발생되는 예외
		처리방법 1] 예외가 발생한 지점을 try~catch문으로 직접 감싸서 처리한다.
		처리방법 2] "예외던지기"를 수행한다.
			main메서드에 throws IOException을 기술하면 해당 메서드 내에서 발생되는 예외를 프로그램 외부로 던지기 할 수 있다.

...
public class Ex02PreDefineException1 {
	...
	public static void main(String[] args) {
		...
		예외가 발생되면 JVM(자바가상머신)은 해당 예외에 관련된 인스턴스를 만들어서 프로그램쪽으로 전달(throw)한다.
		이때 catch절에서 예외인스턴스를 잡아주는 것을 "예외처리"라고 한다.
		만약 예외인스턴슬르 잡아주지 못하면 프로그램은 비정상적인 종료로 이어진다.
		 */
		try {
			intArr[0] = 100;
			...
			// 예외메시지 2 : 간략한 설명을 출력한다.
			System.out.println("예외메세지 : " + e.getMessage());
			/*
			예외메세지 3 : 예외에 대한 디테일한 설명을 출력한다. 가장 많이 사용된다.
			 */
			e.printStackTrace();
		}
		...
		즉 예외처리의 목적은 프로그램이 비정상적으로 중단되지 않도록 하는데에 있다.
		 */

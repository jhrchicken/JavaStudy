...
Exception 클래스는 모든 예외를 catch 할 수 있으므로 반드시 마지막 블럭에 사용해야 한다.
 */
...
public class Ex04MultiCatch {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			1번 인덱스에 0을 입력하는 연산이 불가능하므로 예외가 발생한다.
			 */
			...
			/*
			Exception 클래스는 모든 예외클래스의 부모이므로 catch절의 마지막에 기술해야 한다.
			위쪽으로 이동시키면 에러가 발생한다.
			해당 클래스로 모든 예외를 catch 할 수 있기 때문이다.
			 */
		...
		즉 실행의 흐름이 마지막까지 이어지게 하는 것이 "예외처리"의 목적이다.
		 */

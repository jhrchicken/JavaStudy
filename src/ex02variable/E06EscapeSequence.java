...
public class E06EscapeSequence {
	...
	public static void main(String[] args) {
		...
		/*
		실수는 %f를 사용한다. 또한 정수와 실수의 연산이므로 결과는 실수가 반환되어 double 타입의 변수에 대입해야 한다.
		 */
		...
		%6.2 : 실수 출력시 전체자리수는 6자리, 소수이하 2자리로 표현한다.
		또한 양수는 우측정렬, 음수는 좌측정렬된다.
		 */
		System.out.printf("국어: %d, 영어: %d, 수학: %d, 평균: %f", kor, eng, math, avg);
		System.out.printf("국어: %6d, 영어: %6d, 수학: %6d, 평균: %7.4f", kor, eng, math, avg);
		System.out.printf("국어: %-6d, 영어: %-6d, 수학: %-6d, 평균: %-7.2f", kor, eng, math, avg);
	}

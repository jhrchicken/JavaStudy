...
public class E02StringMethod2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("String 클래스의 주요 메소드 2");
		...
		System.out.println("str1 첫번째 문자의 아스키코드 : " + str1.codePointAt(0)); // 87
		System.out.println("str2 세번째 문자의 아스키코드 : " + str2.codePointAt(2)); // 50556
		...
		/*
		9] format() : 출력 형식을 지정하여 문자열로 반환할 때 사용한다.
		...
		/*
		차후 웹애플리케이션 제작에서 이와 같이 처리하여 웹브라우저에 출력한다.
		 */

...
public class E02StringMethod3 {
	...
	public static void main(String[] args) {
		...
		/*
		13] split() : 문자열을 구분자로 통해 분리해서 String 형의 배열로 반환한다.
		...
		14] substring() : 시작 인덱스와 마지막 인덱스 사이의 문자열을 잘라서 반환한다.
			방법 1 : 인덱스 하나만 사용 => 사용한 인덱스부터 끝까지를 잘라낸다.
			방법 2 : 2개의 인덱스 사용 => 시작, 종료 인덱스가 되므로 해당 구간의 문자열을 잘라낸다.
		 */

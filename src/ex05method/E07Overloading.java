...
public class E07Overloading {
	...
	static void person(int juminNum) {
		System.out.println("미필자이거나 여성 이시군요");
		System.out.println("주민번호 : " + juminNum);
	}

	/*
	해당 메서드는 앞에서 선언한 것과 반환타입만 다른 경우이므로 person(10) 으로 호출했을 때 어떤 메서드를 호출할지 애매하므로 에러가 발생한다.
	...
	*/
	...
	public static void main(String[] args) {
		...
		/*
		출력을 위해 사용하는 print()가 대표적인 오버로딩을 정의된 메서드이다.

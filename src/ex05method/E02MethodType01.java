...
Java 에서의 Naming rule(이름을 지을때의 규칙)
- 클래스 : GoodMorning
...
public class E02MethodType01 {
	...
	static void returnError() {
		...
		/*
		이와 같이 메서드 중간에 return을 기술하면 즉시 종료되므로 그 아래에 있는 코드는 실행되지 않는 쓰레기코드가 된다.
		따라서 return 은 반드시 조건문과 함께 기술되어야 한다.
		단 메서드의 마지막 라인에 기술한다면 조건문이 없어도 상관없다.
		 */
		// return;

		// 이와 같이 return 문이 중간에 있으려면 조건부로 기술해야된다.
		if (returnValue % 2 == 0) {

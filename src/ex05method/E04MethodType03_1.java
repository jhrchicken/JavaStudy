...
/*
메서드형식 3] 매개변수는 있으나 반환값은 없는 경우
: 값을 전달받은 후 연산하고 해당 결과를 반환하지 않고 즉시 출력하는 경우에 사용한다. 즉 값을 소비하는 형태의 메소드이다.
 */
public class E04MethodType03_1 {

	/*
	시나리오] 사용자가 입력한 2개의 시작값과 끝값 사이에 있는 수를 모두 더하여 출력하는 프로그램을 작성하시요.
	출력결과]
		시작값 : 5
		종료값 : 9
		결과 : 5+6+7+8+9=???
	...
	public static void main(String[] args) {
		...
		/*
		반환값이 없는 메서드이므로 단독적으로 호출한다. 앞에서 입력받은 2개의 정수를 인수(Arguments)로 전달한다.
		 */
		myWantSum(s, e);
	}

	/*
	main 메서드에서 호출 시 전달한 2개의 인수를 매개변수를 통해 순서대로 받는다.

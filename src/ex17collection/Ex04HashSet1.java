...
- 개발자가 정의한 클래스라면 hashCode(), equals() 메서드를 적절히 오버라이딩 해야만 중복을 제거할 수 있다.
...
public class Ex04HashSet1 {
	...
	public static void main(String[] args) {
		...
		// size()를 통해 저장된 인스턴스의 개수를 출력
		System.out.println("[중복저장 전 객체수] : " + set.size()); // 5
		/*
		기본클래스의 인스턴스 중복저장
		...
		/*
		이터레이터를 통한 인스턴스 출력 : 순서없이 저장되므로 출력의 순서도 정할 수 없다.
		 */
		...
		while (itr.hasNext()) {
			...
			우리가 직접 정의한 클래스에 대해서만 instanceof를 통해 타입을 확인한 후 다운캐스팅 하여 출력한다.

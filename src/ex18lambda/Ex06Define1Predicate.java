...
public class Ex06Define1Predicate {
	...
	public static void main(String[] args) {
		...
		매개변수로 Human 인스턴스를 전달하고, getter인 getGender()를 통해 성별이 '남'인 경우 true를 반환하도록 정의되어 있다.
		 */
		...
		이와 같이 람다식을 정의한 후 참조변수인 aaa를 전달하는 것과 동일하게 람다식 자체를 매개변수로 사용하고 있다.
		 */
	...
	두번째 매개변수는 4개의 Human 인스턴스가 저장된 List 컬렉션이다.
	 */
	public static double avg(Predicate<Human> ph, List<Human> li) {
		// 카운트용 변수
		int pCount = 0;
		int tCount = 0;
		// List에 저장된 Human인스턴스의 개수만큼 반복 (확장 for문)
		for (Human h : li) {

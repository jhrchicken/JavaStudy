/*
패키지 선언부 : 현재 작성하는 클래스의 위치를 결정하기 위한 선언으로 해당 클래스를 특정 패키지 하위에 묶어 정의하겠다는 뜻이다.
 */
package ex09package;
...
public class E01PackageMain {
	...
	public static void main(String[] args) {
		...
		방법 2 : 하나의 클래스는 import 하고, 다른 하나는 풀패키지 경로를 사용한다.
		 */
		// 상단에 import 한 클래스를 통해 인스턴스 생성
		...
		/*
		static으로 선언된 메서드는 new를 통해 인스턴스 생성없이 클래스 명으로 직접 메서드를 호출할 수 있다.
